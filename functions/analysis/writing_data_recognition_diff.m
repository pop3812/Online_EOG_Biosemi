...
result_save_route = 'C:\Users\User\Documents\GitHub\Data\20141223_LeeKR\classification_results_diff\';
...
for i = 1:26
   for j = 1:n_set
       ...
       pad = [0 0];
       alphabet_dict_norm{i, j} = diff(downsample(alphabet_dict_norm{i, j}, D_Rate));
...
for tr_idx = 1:n_set
    ...
    % Save results
    save_route = [result_save_route, 'analysis_result_method_', num2str(method_distanceMetrics), '_DR_', num2str(D_Rate), '_diff.mat'];
